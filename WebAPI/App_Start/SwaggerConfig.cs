    ...
    public class SwaggerConfig
    {
        ...
        private static void ConfigureSwaggerUi()
        {
            ...
            GlobalConfiguration.Configuration.EnableSwagger(c =>
            {
                ...
                {
                    c.InjectStylesheet(typeof(SwaggerConfig).Assembly, "WebAPI.Swagger.theme-flattop.css");
                    c.InjectJavaScript(typeof(SwaggerConfig).Assembly, "WebAPI.Swagger.translator.js");
        ...
        {
            var re = System.String.Format(@"{0}\bin\WebAPI.XML", System.AppDomain.CurrentDomain.BaseDirectory);
            return re;
        }
